...
public interface IJ2EEFacetConstants {
	...
	public static final IProjectFacetVersion ENTERPRISE_APPLICATION_110 = J2EEFacetConstantsProvider.getProjectFacetVersion(ENTERPRISE_APPLICATION_FACET, "11.0"); //$NON-NLS-1$
	...
	public static final IProjectFacetVersion APPLICATION_CLIENT_110 = J2EEFacetConstantsProvider.getProjectFacetVersion(APPLICATION_CLIENT_FACET, "11.0"); //$NON-NLS-1$
	...
	public static final IProjectFacetVersion EJB_40 = J2EEFacetConstantsProvider.getProjectFacetVersion(EJB_FACET, "4.0"); //$NON-NLS-1$
	...
	public static final IProjectFacetVersion DYNAMIC_WEB_61 = J2EEFacetConstantsProvider.getProjectFacetVersion(DYNAMIC_WEB_FACET, "6.1"); //$NON-NLS-1$
	...
	public static final IProjectFacetVersion JCA_21 = J2EEFacetConstantsProvider.getProjectFacetVersion(JCA_FACET, "2.1"); //$NON-NLS-1$
	...
	public static final IProjectFacetVersion WEBFRAGMENT_50 = J2EEFacetConstantsProvider.getProjectFacetVersion(WEBFRAGMENT_FACET, "5.0"); //$NON-NLS-1$
	public static final IProjectFacetVersion WEBFRAGMENT_60 = J2EEFacetConstantsProvider.getProjectFacetVersion(WEBFRAGMENT_FACET, "6.0"); //$NON-NLS-1$
